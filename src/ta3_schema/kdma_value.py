...
class KDMAValue(BaseModel):
    ...
    """ # noqa: E501
    kdma: StrictStr = Field(description="KDMA name")
    value: Union[Annotated[float, Field(le=1.0, strict=True, ge=0.0)], Annotated[int, Field(le=1, strict=True, ge=0)]] = Field(description="target alignment value")
    __properties: ClassVar[List[str]] = ["kdma", "value"]
