...
class KDMAValue(BaseModel):
    """
    Single KDMA value with values between 0 and 1, or a kernel density estimate of the KDMA value.
    """ # noqa: E501
    ...
    kdes: Optional[Dict[str, KDEData]] = Field(default=None, description="A character id with an indicator of how mission-critical that character is")
